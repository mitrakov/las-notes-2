...
:: modify db.dart file for Windows build
echo Modifying db.dart...
copy /y lib\model\db.dart lib\model\db.dart.bkp
...
move /y lib\model\db.dart.bkp lib\model\db.dart
...
if not exist "sqlcipher\windows\sqlite3.dll" (
    echo Error: Library missing: sqlcipher\windows\sqlite3.dll
    exit /b 1
)
...
copy /v sqlcipher\windows\sqlite3.dll "%BUILD_PATH%"
